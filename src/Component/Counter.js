...
const [count,setcount]=useState(false);
    return(
        ...
        <div className="box text-center">
            ...
            <i class="fa-sharp fa-solid fa-paint-roller pb-4 fs-1"></i>
            <ScrollTrigger onEnter={()=>{setcount(true)}} onExit={()=>{setcount(false)}}>
            <h2>
            {count && <CountUp start={0} end={100} duration={2} delay={0} /> }+ </h2>
            </ScrollTrigger>

            <p className="fs-3 fw-bold pt-2" >Satisfied Clients</p>
            </div>
            <div className="col-lg-3">
            <i class="fa-solid fa-brush fs-1 pb-4"></i>
            <ScrollTrigger onEnter={()=>{setcount(true)}} onExit={()=>{setcount(false)}}>
            <h2>
            {count && <CountUp start={250} end={500} duration={2} delay={0} /> }K </h2>
            </ScrollTrigger>
            <p className="fs-3 fw-bold pt-2" >Active Clients</p>
            </div>
            <div className="col-lg-3">
            <i class="fa-solid fa-palette fs-1 pb-4 "></i>
            <ScrollTrigger onEnter={()=>{setcount(true)}} onExit={()=>{setcount(false)}}>
            <h2>
            ...
            <div className="col-lg-3">
            <i class="fa-solid fa-paintbrush fs-1 pb-4"></i>
            <ScrollTrigger onEnter={()=>{setcount(true)}} onExit={()=>{setcount(false)}}>
            <h2>
